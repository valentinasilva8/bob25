...
import { Badge } from "@/components/awe/ui/badge"
...
import ScrollVelocity from "@/components/awe/scroll-velocity"
import CountUp from "@/components/awe/count-up"
import SplitTextAnimated from "@/components/awe/split-text-animated"
...
export default function ResultsPage() {
  ...
  useEffect(() => {
    const storedResults = sessionStorage.getItem("adGenerationResults")
    if (storedResults) {
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {results.generated_ads.map((ad, index) => (
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {results.channel_recommendations.map((channel, index) => {
                ...
                <Card key={index} className="border-2">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className={getPriorityColor(channel.priority)}>{channel.priority}</Badge>
                    </div>
                  </CardHeader>
                  <CardContent>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-lg font-bold">
                    <CountUp to={results.environmental_impact.energy_kwh} duration={2} separator="," /> kWh
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-medium">CO₂ Emissions</span>
                  <span className="text-lg font-bold">
                    <CountUp to={results.environmental_impact.co2_kg} duration={2} separator="," /> kg
                  </span>
                </div>
                <div className="flex items-center justify-between">
            ...
            <Card className="border-2 bg-gradient-to-br from-orange-50 to-blue-50">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <SplitTextAnimated
                    text={results.targeting_metrics.location}
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold">{results.targeting_metrics.age_range}</p>
                </div>
                <div>
                  <span className="text-sm font-medium text-muted-foreground">Interests</span>
                  <div className="flex flex-wrap gap-2 mt-2">
                    {results.targeting_metrics.interests.map((interest, index) => (
