...
import { Progress } from "@/components/awe/ui/progress"
import { Checkbox } from "@/components/awe/ui/checkbox"
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/awe/ui/select"
...
export default function RegisterPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Store the results in sessionStorage to display on the results page
      sessionStorage.setItem("adGenerationResults", JSON.stringify(data))
