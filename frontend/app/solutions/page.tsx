        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div className="text-center">
              <div className="mb-2 text-4xl font-bold text-primary md:text-5xl">3.2x</div>
              <div className="text-sm font-medium text-muted-foreground">Average ROI Increase</div>
            </div>
            <div className="text-center">
              <div className="mb-2 text-4xl font-bold text-primary md:text-5xl">67%</div>
              <div className="text-sm font-medium text-muted-foreground">Reduction in Ad Costs</div>
            </div>
            <div className="text-center">
              <div className="mb-2 text-4xl font-bold text-primary md:text-5xl">89%</div>
              <div className="text-sm font-medium text-muted-foreground">Customer Satisfaction</div>
            </div>
            <div className="text-center">
              <div className="mb-2 text-4xl font-bold text-primary md:text-5xl">24hrs</div>
